...
public class RegistrationAdminUpdateField extends JPanel {
	...
	public RegistrationAdminUpdateField( User user, RegistrationAdminFacade registrationAdminFacade) {
		this.user = user;
		...
		firstnameTexfield = new JTextField(user.getUserfirstname());
		...
		lastnameTexfield = new JTextField(user.getUsername());
		...
		telephoneTexfield = new JTextField(user.getPhone());
		...
		postcodeTexfield = new JTextField(user.getPostcode());
		...
		cityTexfield = new JTextField(user.getCity());
		...
		address2Texfield = new JTextField(user.getAddress2());
		...
		JButton btnUpdateUser = new JButton("Update the User");
		springLayout.putConstraint(SpringLayout.SOUTH, btnUpdateUser, -32, SpringLayout.SOUTH, this);
		springLayout.putConstraint(SpringLayout.EAST, btnUpdateUser, -207, SpringLayout.EAST, this);
		add(btnUpdateUser);
		...
		usermailTextField = new JTextField(user.getUsermail());
		...
		address1TextField = new JTextField(user.getAddress1());
		...
		btnUpdateUser.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				boolean result = registrationAdminFacade.setRagistration( firstname, lastname, address, address2, city, postcode, telephone, password,user );
				if( result){
					JOptionPane.showMessageDialog(new JPanel(),"update completed !");
				}
				else
				{
					JOptionPane.showMessageDialog(new JPanel(),"erreur update !");
				}
