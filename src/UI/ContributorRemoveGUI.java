...
public class ContributorRemoveGUI extends JPanel {
...
this.setSize(640, 480);
		...
		btnSubmit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Boolean isAdd = myFacade.deleteContributor(txtContributorName.getText(), txtContributorFirstName.getText());
				
				if(!isAdd){
					//Error popup 
					JOptionPane.showMessageDialog(null, "The user "+txtContributorFirstName.getText()+" "+txtContributorName.getText()+" is still a contributor", "Error", JOptionPane.ERROR_MESSAGE);
				}
				else{
					//Information popup
					JOptionPane.showMessageDialog(null, "The user "+txtContributorFirstName.getText()+" "+txtContributorName.getText()+" is no longuer a contributor.", "Success", JOptionPane.INFORMATION_MESSAGE);
					MainFrame.getMainFrame().setMainPanel(new ContributorManagementMenuGUI());
				}
			}});
